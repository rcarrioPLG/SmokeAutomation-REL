 ...
 * Descripción: Validar que un lote sea desactivado en Administrador/Inventario.
 */
WebUI.openBrowser('')
...
WebUI.click(findTestObject('Object Repository/Page_Administrador/div__cmbEstado-trigger-picker'))

WebUI.click(findTestObject('Object Repository/Page_Administrador/li_Desactivado'))
