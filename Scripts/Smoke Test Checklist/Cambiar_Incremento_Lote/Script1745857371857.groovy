 ...
 * Descripción: Validar la modificación del valor en campo "Incremento" de un lote en Administrador/Inventario.
 */
WebUI.openBrowser('')
...
WebUI.setText(findTestObject('Object Repository/Page_Administrador/input_Incremento_txtIncremento1'), '1.000.000')
